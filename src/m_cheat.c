...
struct cheat_s cheat[] = {
  ...
  {"tntkey",     NULL,                not_net | not_demo,
   cheat_tntkey   },     // killough 2/16/98: generalized key cheats //所以钥匙
  ...
  {"tntweap",    NULL,                not_net | not_demo,
   cheat_tntweap  },     // killough 2/16/98: generalized weapon cheats //获得指定武器
  ...
  {"tntfast",    NULL,                not_net | not_demo,
   cheat_fast       },   // killough 3/6/98: -fast toggle //怪物加速
